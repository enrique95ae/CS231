		.data
str1:			.asciiz	"\n How many divisible by 6 numbers do you want to add: "
str2:			.asciiz "\n Enter a number: "
str3:			.asciiz "\n The total is: "
str4:			.asciiz "\n The number is not divisible by 6. Enter another number."
str5:			.asciiz "\n The number is not in the range 1-100. Enter another number. "
str6:			.asciiz "\n The number is not possitive. Enter another number. "
